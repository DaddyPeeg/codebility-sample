...
const CompanyEditModal = () => {
  ...
  const isModalOpen = isOpen && type === "companyEditModal"
  return (
              ...
              <div>
                ...
                <div className="w-full items-center gap-6 md:flex">
                  <div className="w-full space-y-2">
                    ...
                    <Input className="" placeholder="Company Name" value={company_name} />
                  </div>
                  <div className="w-full space-y-2">
                    <Label className="text-gray">Working Hours</Label>
                    <Input className="" placeholder="08:00am - 05:00pm" value={working_hours} />
                  </div>
                </div>
                <div className="mt-2 w-full space-y-2">
                  <Label className="text-gray">History</Label>
                  <Input className="" placeholder="History" value={company_hist} />
                </div>
              </div>
              <div className="">
                ...
                <div className="w-full items-center gap-6 md:flex">
                  <div className="w-full space-y-2">
                    ...
                    <Input className="" placeholder="Email" value={email} />
                  </div>
                  <div className="w-full space-y-2">
                    <Label className="text-gray">Telephone</Label>
                    <Input className="" placeholder="+639" value={contact_number} />
                  </div>
                </div>
                <div className="w-full items-center gap-6 md:flex">
                  <div className="w-full space-y-2">
                    <Label className="text-gray">Address</Label>
                    <Input className="" placeholder="Address" value={location} />
                  </div>
                  <div className="w-full space-y-2">
                    <Label className="text-gray">Linkedin</Label>
                    <Input className="" placeholder="Linkedin" value={linkedin_link} />
                  </div>
                </div>
              </div>
            </div>
